...
import by.gsu.roadstatusservice_android.fragments.MyMapLocationFragment;
...
public class LocationActivity extends AppCompatActivity  implements OnMapReadyCallback {
    ...
    private List<Picture> store = new ArrayList<Picture>() {
        {
            ...
            add(new Picture(4, "ssss.jpg", "dogs fail", new Point(31, 52)));
    ...
    private List<Picture> pictures = store;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment frag2 = new MyMapLocationFragment();
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.add(R.id.mapFragment, frag2);
        ft.commit();
